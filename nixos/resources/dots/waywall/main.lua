...
return function(cfg, remaps)
    ...
    config.actions = {
        ...
        [cfg.launch_ninbot_key] = function()
            waywall.exec(nb_cmd)
            waywall.sleep(500)           -- give the JVM time to map
            waywall.show_floating(true)
        end,

        [cfg.toggle_ninbot_key] = helpers.toggle_floating,
        ...
        ["Shift-I"] = function()
            ...
            keybinds_text = waywall.text(
                ...
                "Wide = " .. cfg.wide.key .. "\n" ..
                "Tall = " .. cfg.tall.key .. "\n" ..
                "Launch Ninbot = " .. cfg.launch_ninbot_key .. "\n" ..
